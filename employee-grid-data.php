...
include 'ajax_datatables/connect_database.php';
...
$sql = "SELECT nama_level, created_at ";
$sql.=" FROM level_positions";
...
$sql = "SELECT nama_level, created_at ";
$sql.=" FROM level_positions WHERE 1=1";
if( !empty($requestData['search']['value']) and strlen($requestData['search']['value']) > 3) {   // if there is a search parameter, $requestData['search']['value'] contains search parameter
	$sql.=" AND ( nama_level LIKE '%".$requestData['search']['value']."%' ";    
